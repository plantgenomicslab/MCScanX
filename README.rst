...
- Usage::
	...
	$ MCScanX/duplicate_gene_classifier  dir/xyz
...
- Usage::
	...
	$ MCScanX/downstream_analyses/detect_syntenic_tandem_arrays -g gff_file -b blast_file -c collinearity_file -o output_file
...
- Usage::
	...
	$ MCScanX/downstream_analyses/dissect_multiple_alignment -g gff_file -c collinearity_file -o output_file
